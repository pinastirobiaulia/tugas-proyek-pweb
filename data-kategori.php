				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="edit-kategori.php?id=<?php echo $row['id_kategori'] ?>">Edit</a> || <a href="proses-hapus.php?idk=<?php echo $row['id_kategori'] ?>" onclick="return confirm('Yakin ingin hapus?')">Hapus</a>
							</td>
						</tr>
						<?php }} else{ ?>
							<tr>
