				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="produk/<?php echo $row['gambar_produk'] ?>"> <img src="produk/<?php echo $row['gambar_produk'] ?>" width="50px"></td>
							<td><?php echo ($row['status_produk'] == 0)? 'Tidak Aktif':'Aktif'; ?></td>
							<td>
								<a href="proses-hapus.php?idp=<?php echo $row['id_produk'] ?>" onclick="return confirm('Yakin ingin hapus?')">Hapus</a>
							</td>
						</tr>
						<?php }} else { ?>
							<tr>
